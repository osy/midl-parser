"""Classic MIDL Parser - A complete parser for classic Microsoft Interface Definition Language files.

(Parses classic MIDL, used for COM/RPC/DirectX. MIDL 3.0 / MIDLRT is not supported.)
